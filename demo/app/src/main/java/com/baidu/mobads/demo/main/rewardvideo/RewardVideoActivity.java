...
//    private static final String AD_PLACE_ID = "8264685";
    ...
    class CustomRewardListener implements RewardVideoAd.RewardVideoAdListener {
        ...
        public void onRewardVerify(boolean rewardVerify, Map<String, Object> rewardInfo) {
            // 激励视频奖励回调
            Log.i(TAG, "onRewardVerify: " + rewardVerify + ", rewardType: " + rewardInfo.get("reward_type"));
        }
    ...
    private void loadNextVideo() {
        ...
        mRewardVideoAd = new RewardVideoAd(RewardVideoActivity.this,
                mAdPlaceIdView.getText().toString(), new CustomRewardListener());
    ...
    private void initView() {
        ...
        Button btn3 = this.findViewById(R.id.btn_show_across_activity);
        btn3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                // 跨页面展示激励视频广告示例
                Intent intent = new Intent(RewardVideoActivity.this, RewardTaskAActivity.class);
    ...
    private void toastText(String text) {
        Toast.makeText(RewardVideoActivity.this, text, Toast.LENGTH_SHORT).show();
    }
