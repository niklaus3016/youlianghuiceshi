 ...
 */
public class TuiJianFragment extends Fragment implements NativeCPUManager.CPUAdListener {
    ...
    public static CpuVideoView mCpuVideoView;
...
//        adapter.resume();
    ...
    public void loadAd(int pageIndex) {
        ...
        mCpuManager.loadAd(pageIndex, 1022, true);
