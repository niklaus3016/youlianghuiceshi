...
public class NativeADUnifiedRecyclerViewActivity extends BaseActivity
  ...
  private static final int AD_DISTANCE = 3;
...
//        super.onScrollStateChanged(recyclerView, newState);
  ...
  class CustomAdapter extends RecyclerView.Adapter<CustomHolder> {
    ...
    private void initItemView(int position, final CustomHolder holder) {
      ...
      // TODO 用来测试的代码，上线前删除
      Map<String, String> expDevExtra = (Map<String, String>) ad.getExtraInfo().get(
          "exp_dev_extra");
      if (expDevExtra != null) {
        expDevExtra.put("slot", String.valueOf(position));
      }
      Map<String, String> clickDevExtra = (Map<String, String>) ad.getExtraInfo().get(
          "click_dev_extra");
      if (clickDevExtra != null) {
        clickDevExtra.put("slot", String.valueOf(position));
      }
    ...
    private void setAdListener(final CustomHolder holder, final NativeUnifiedADData ad) {
      ...
      ad.setNativeAdEventListener(new NativeADEventListenerWithClickInfo() {
        ...
        public void onADError(AdError error) {
          ...
          BuildConfig.CallbackLogUtil.logError(TAG);
        }
        ...
        public void onADStatusChanged() {
          ...
          BuildConfig.CallbackLogUtil.logADStatusChanged(TAG);
        }
      });
      // 视频广告
      if (ad.getAdPatternType() == AdPatternType.NATIVE_VIDEO) {
        bindMediaView(holder, ad);
      }
    }
  ...
  protected void bindMediaView(CustomHolder holder, NativeUnifiedADData ad) {
        ...
        case MSG_REFRESH_LIST:
          ...
          if (ads != null && ads.size() > 0 && mAdapter != null) {
            for (int i = 0; i < ads.size(); i++) {
              ...
              int position = count + i * AD_DISTANCE + FIRST_AD_POSITION;
              mAdapter.addAdToPosition(ads.get(i), position);
