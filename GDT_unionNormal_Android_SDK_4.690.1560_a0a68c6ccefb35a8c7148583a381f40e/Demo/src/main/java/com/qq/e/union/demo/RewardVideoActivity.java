...
public class RewardVideoActivity extends BaseActivity implements RewardVideoADListener,
  ...
  public void onReward(Map<String, Object> map) {
    Log.i(TAG, "onReward " + map.get(ServerSideVerificationOptions.TRANS_ID) + " " + map.get(IReward.DEV_EXT));  // 获取服务端验证的唯一ID和额外信息
    BuildConfig.CallbackLogUtil.logAdReward(TAG);
  }
  ...
  public void onVideoComplete() {
    BuildConfig.CallbackLogUtil.logVideoComplete(TAG);
  }
  ...
  public void onError(AdError adError) {
    ...
    DemoBiddingC2SUtils.reportBiddingNoAd(mRewardVideoAD);
  }
